 ...
 * nickName louyedaren
 */
public class PearlDecorator extends AbstractMilkTeamDecorator {
	private AbstractMilkTea abstractMilkTea;

	public PearlDecorator(AbstractMilkTea abstractMilkTea) {
		this.abstractMilkTea = abstractMilkTea;
	}

	@Override
	public String getDescription() {
		return abstractMilkTea.getDescription()+",加珍珠，";
	}

	@Override
	public int cost() {
		return abstractMilkTea.cost()+5;
	}
